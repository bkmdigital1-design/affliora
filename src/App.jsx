...
// ========== ADD THIS RIGHT AFTER YOUR ROUTE DETECTION ==========
// (Around line 310, right after all your const declarations)

// HOMEPAGE CHECK - MUST BE FIRST!
// If we're on the root path, show the homepage immediately
if (!isAdminRoute && (currentPath === "" || currentPath === "/")) {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 pb-6">
          <div className="mt-6 flex flex-col md:flex-row gap-4">
            ...
            <select 
              ...
              className="px-4 py-3 border rounded-xl bg-white text-gray-600 font-medium"
            >
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <section className="mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-md">
            <h2 className="text-3xl font-bold text-gray-600">Find the best digital tools and courses</h2>
            <p className="mt-2 text-gray-600">A curated collection of digital products - tutorials, tools, templates and more.</p>
          </div>
        </section>
        ...
        <section id="products">
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2 mt-auto">
                        ...
                        <button 
                          ...
                          className="w-full bg-gradient-to-r from-purple-600 to-purple-600 text-white px-4 py-2.5 rounded-lg font-medium text-sm hover:from-purple-700 hover:to-purple-700 transition-all"
                        >
                          Get Product
                        </button>
                      </div>
          ...
          <div className="mt-8 flex items-center justify-center gap-3">
            ...
            <button 
              disabled={(page * PAGE_SIZE) >= products.filter(p => p.visible !== false).length} 
...
// THEN your other routes continue (Article Page, Product Detail, Admin, etc.)
